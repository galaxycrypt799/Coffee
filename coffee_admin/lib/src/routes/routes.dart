...
import '../modules/operations/blocs/users_list_bloc/users_list_bloc.dart';
...
import '../modules/operations/views/users_screen.dart';
            ...
            routes: [
              ...
              GoRoute(
                ...
                builder: (context, state) => MultiBlocProvider(
                  providers: [
                    BlocProvider(
                      create: (context) => OrdersBloc(context.read<OrderRepo>())
                        ..add(const GetOrders()),
                    ),
                    BlocProvider(
                      create: (context) =>
