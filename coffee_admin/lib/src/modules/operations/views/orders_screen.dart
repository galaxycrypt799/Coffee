                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildStatItem(
                          "Đã giao", state.completedOrders.toString()),
                    ],
                  ),
                );
              }
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ExpansionTile(
                  ...
                  subtitle: Text(
                      "Khách: ${order.customerName} • ${DateFormat('HH:mm dd/MM').format(order.createdAt)}"),
                  trailing: DropdownButton<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'confirmed', child: Text("Đã nhận")),
                      DropdownMenuItem(
                          value: 'preparing', child: Text("Đang pha")),
                    ...
                    onChanged: (val) {
                      if (val != null) {
                        context
                            .read<OrdersBloc>()
                            .add(UpdateOrderStatus(order.id, val));
                      }
                    },
                  ),
                  children: [
