...
class AppBootstrap {
  ...
  static Future<AppBootstrap> initialize() async {
    if (!DefaultFirebaseOptions.isConfigured) {
      return _local(
        statusMessage:
            'Đang trong chế độ demo. Toàn bộ thực đơn và dữ liệu được lưu trữ trực tiếp trên thiết bị.',
      );
    }
    ...
    try {
      ...
      return AppBootstrap._(
        ...
        statusTitle: 'Online',
        statusMessage:
            'Tài khoản và thực đơn đang được đồng bộ hóa trực tiếp từ hệ thống DrinkHub.',
      );
